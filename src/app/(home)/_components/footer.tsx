    ...
    return (
        <footer className='flex flex-col justify-start bg-dark-green-15 px-4 py-8 mt-12'>
            <div className='flex items-center justify-between  mb-5'>
                <Image src='/imgs/logo.png' alt='logo' width={50} height={75} className='ml-2' />
            ...
            <ul className='flex flex-col sm:flex-row sm:justify-between gap-4 p-4 bg-dark-green-20 rounded-lg justify-center text-center text-white'>
                ...
                <li className='text-grey-95 mt-1 sm:ml-auto'>
                    ...
                    Developed with ❤️ by <Link href="https://takeshy.tech" target="_blank" rel="noopener noreferrer" className='text-transparent animate-text bg-gradient-to-r from-green-500 to-blue-500 rounded-lg  bg-clip-text font-black'>Takeshy</Link>
                </li>
            </ul>
        </footer>
    )

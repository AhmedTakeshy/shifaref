        ...
        <section className="flex flex-col items-center justify-between mb-12 sm:flex-row gap-x-10">
            ...
            <article className="container flex flex-col justify-center my-12 ml-0 text-center sm:my-0 sm:w-5/12 gap-y-4 text-dark-green-15 sm:text-left">
                ...
                <div className="flex items-center justify-center mt-12 gap-x-4 sm:justify-normal">
                    <Button className="transition-colors duration-300 border border-transparent bg-light-green-70 text-dark-green-15 hover:border-light-green-70 hover:bg-transparent">Get Start Today</Button>
                    <Button className="transition-colors duration-300 border border-transparent bg-light-green-85 text-dark-green-15 hover:border-light-green-85 hover:bg-transparent">Book Demo</Button>
                </div>
            </article>
        </section>
    )
